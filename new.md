...
### **[Get-Query](https://github.com/Lifailon/Get-Query)**
Используется для парсинга программы **query.exe с выводом в PSObject**, с целью отображения текущих сессий и запущенных пользовательских процессов (версия 1.2) на компьютере.

### **[Get-Invent](https://github.com/Lifailon/Get-Invent-SQLite)**
Используется для сбора данных об оборудовании на удаленном компьютере с выводом в HTML-файл (версия 1.1).
