...
* **Admin - Services** используется для вывода списка служб на локальном или удаленном компьютере с возможность их запуска/перезапуска и остановки.
...
* **Admin & WMI - Sowtware** - используется для вывода списка установленного программного обспечения с возможность его удаления
* **WMI - Windows Update** - используется для вывода списка обновлений с дальнейшим поиском по **HotFixID в DISM Packages** и удалением.
* **Admin - SMB Open Files** - используется для отображения списка используемых сетевых сесурсов пользователями в сети с возможность закрытия их сессии.
* **Admin - Get-Netstat** - используется для вывода списка слушающих и установленных TCP-соединений с преобразованием имени удаленного хоста (nslookup) и используемого процесса.
* **Admin - Get-RemoteDNS**
* **Admin - GPUpdate** - 
* **Admin - GPResult** - 
