...
## Вторая цель программы - автоматизация удаленного администрирования, который содерджит более 30 скриптов по удаленному взаимодействию с серверами и рабочими станциями. Присутствует индивидуальный вывод всех команд в статус-бар.
