...
## Обновление 1.3.2
* При внесении изменений в список серверов, возможно обновление списка из самой программы нажатием правой кнопки мыши - обновить, или сочетанием клавиш Ctrl+R.
* Добавлена возможность заполнить список серверов всеми компьютерами в домене (Файл - Список серверов домена или Ctrl+D).
* Добавлена возможность выбора внешнего источника синхронизации компьютерных часов, например: ru.pool.ntp.org (Время - Изменить источник)
* В меню Питание добавлены скрипты по отключению/включению спящего режима и блокировки экрана
