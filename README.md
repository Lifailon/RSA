...
* Таблица списка серверов домена с возможность поиска зарегестрированных на них пользователях (ManagedBy) а так же сортировки по статусу (Активный/Заблокирован), версии ОС и времени создания (Ctrl+T).
