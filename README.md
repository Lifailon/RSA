...
## Обновление 1.3.2
* После внесения изменений в список серверов, возможно обновление списка из самой программы нажатием правой кнопки мыши - обновить, или сочетанием клавиш Ctrl+R.
...
### Скрипты по удаленной активации корпоративных лицензий в сети (KMS).
