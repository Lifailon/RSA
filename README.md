...
Цель программы, подключение к текущим RDP-сессия по средствам **Shadow-подключения**, а так же содержит сборник скриптов по **автоматизации удаленного администрирования**.
...
* Таблица списка серверов домена с возможность поиска зарегестрированных на них пользователях и версией ОС а так же сортировки по их статусу и времени создания (Ctrl+T).
