...
## Обновление 1.3.2
* При внесении изменений в список серверов, возможно обновления списка из самой программы нажатием правой кнопкой мыши - обновить, или сочетанием клавиш Ctrl+R.
