...
Программ имеет более 30 скриптов по удаленному взаимодействию с серверами и рабочими станциями. Присутствует индивидуальный вывод всех команд в статус-бар.
...
## Обновление 1.3.2. 
### KMS - скрипты по корпоративной активации в сети.
