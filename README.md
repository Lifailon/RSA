...
Программа для подключения к текущим RDP-сессия по средствам **Shadow-подключения**, а так же содержит сборник скриптов по **автоматизации удаленного администрирования**.
