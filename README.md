...
* Таблица списка серверов домена с возможность поиска зарегестрированных на них пользователях и версией ОС а так же сортировки по их статусу и времени создания.
